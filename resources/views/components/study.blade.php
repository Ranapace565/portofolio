<section class="bg-white dark:bg-gray-900 antialiased" id="pendidikan">
    <div class="max-w-screen-xl px-4 py-8 mx-auto lg:px-6 sm:py-16 lg:py-24">
        ...
        <div class="grid grid-cols-1 mt-12 text-center sm:mt-16 gap-x-20 gap-y-12 sm:grid-cols-2 lg:grid-cols-2 ">
            <div class="space-y-4">
                <span
                    class="bg-primary-100 text-gray-900 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded dark:bg-primary-500 dark:text-gray-300">
                    2023 - Sekarang
                </span>
                <h3 class="text-2xl font-bold leading-tight text-gray-900 dark:text-white">
                    Politknik Negeri Jember
                </h3>
                <p class="text-lg font-normal text-gray-500 dark:text-gray-400">
                    Saya sebagai mahasiswa prodi Teknik Informatika, Jurusan Teknologi Informasi PSDKU Nganjuk.
                </p>
                {{-- <a href="#" title=""
            ...
            <div class="space-y-4">
                ...
                <p class="text-lg font-normal text-gray-500 dark:text-gray-400">
                    Alumni prodi Teknik Komputer Jaringan, Jurusan Teknologi Informasi.
                </p>
                {{-- <a href="#" title=""
                    class="text-white bg-primary-700 justify-center hover:bg-primary-800 inline-flex items-center  focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
                    role="button">
